...
export function useSnapLineEngine(): CoreEngine {
  const engine = useContext(EngineContext);
  if (!engine) {
    throw new Error("SnapLine React components must be rendered inside <Engine>.");
  }
  return engine;
}
...
export function SnapLineEngine({
  children,
  className,
  debug = false,
  engine = null,
...
export { SnapLineEngine as Engine };
